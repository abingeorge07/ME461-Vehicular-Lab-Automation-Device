...
void getAngle(float* angle){
  ...
  temp1 = ((float)readRegister(G_Y));
  temp2 = ((float)readRegister(G_Z));

  angle[0] = ((temp/32768.0 * 180.0) - angle_offset[0])/3.8;
  angle[1] = ((temp1/32768.0 * 180.0) - angle_offset[1])/3.8;
  angle[2] = ((temp2/32768.0 * 180.0) - angle_offset[2])/3.8;
  ...
  // angle[0] = (temp / 65300.0) - angle_offset[0];
  ...
  // temp = ((float)readRegister(G_Y)  / 32768.0 * 180.0 ) ;
  // angle[1] = temp - angle_offset[1];

  // temp = ((float)readRegister(G_Z)  / 32768.0 * 180.0 ) ;
...
void calibration(void){
  ...
  for(i=0; i<num; i++){
    ...
    temp1 = (((float)readRegister(G_Y))/32768.0 ) * 180;
    temp2 = (((float)readRegister(G_Z))/32768.0 ) * 180;
    // if(i>=20){
  ...
  angle_offset[0] = temp;
  angle_offset[1] = temp1;
  angle_offset[2] = temp2;
